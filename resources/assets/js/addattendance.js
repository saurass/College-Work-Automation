...
{
var tc=document.getElementById("totalAttended"+i).value;
			var ac=document.getElementById("Attended"+i).value;
		     if(tc=='')
		     {
document.getElementById("totalAttended"+i).focus();
...
function studentcount()
	{
		...
		xmlhttp.open("GET","getstudentcount.php?sec="+sec+" & sem="+sem,true)
		xmlhttp.send();

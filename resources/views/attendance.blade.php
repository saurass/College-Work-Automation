...
<aside class="side-navigation green hide-on-med-and-down">
    ...
    <ul>
        <a class="waves-effect waves-ripple" href="#"> <i class="fa fa-pencil-square-o"></i> update<i class="fa fa-arrow-left right oh-here-is-a-back-button"></i></a>
    </ul>
    <ul>
    ...
    <ul>
        <a class="waves-effect waves-ripple" href="#"> <i class="fa fa-download"></i> download<i class="fa fa-arrow-left right oh-here-is-a-back-button"></i></a>
    </ul>
    <ul>

...
<div class="row">
    ...
    <form action="/assignrole/create" method="post">
       ...
       <div class="row center">
        <div class="input-field col s12">
            ...
            <input type="submit" value="Assign New Role To This Post" style="background-color: #6fff93" class="btn btn-large btn-red">
            </div>
        </div>
        </div>
    </form>
    <br><br><br>
    <div class="row"></div>
    <div class="col s10 m10 offset-m4   "><h5 class="left">List Of All Faculty</h5></div><br>
